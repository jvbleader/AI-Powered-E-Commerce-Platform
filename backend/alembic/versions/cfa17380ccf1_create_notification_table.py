...
Revision ID: cfa17380ccf1
Revises: 3bfb83407eba
Create Date: 2026-07-30 16:15:34.456981
...
def upgrade() -> None:
    ...
    op.add_column('notifications', sa.Column('user_id', mysql.CHAR(length=36), nullable=False))
