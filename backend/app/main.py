...
is_production = getattr(settings, "APP_ENV", "").lower() in ("production", "prod")
cors_origin_regex = None if is_production else r"https?://(localhost|127\.0\.0\.1|192\.168\.\d+\.\d+|10\.\d+\.\d+\.\d+|172\.(1[6-9]|2\d|3[0-1])\.\d+\.\d+)(:\d+)?"
