...
const STATUS_TABS = [
  ...
  { key: "DISPUTED", label: "Chờ xử lý (DISPUTED)", highlight: true },
  { key: "SUPPORT_APPROVED", label: "Đã duyệt hoàn tiền (SUPPORT_APPROVED)" },
  { key: "SUPPORT_REJECTED", label: "Đã bác bỏ (SUPPORT_REJECTED)" },
];
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <p className="font-semibold text-slate-800">
                              {item.order?.receiverName || `Khách #${item.userId}`}
                            </p>
                            {item.order?.phone && (
                              <p className="text-[11px] text-slate-400">{item.order.phone}</p>
                            )}
                          </div>
                        </div>
                      </td>
